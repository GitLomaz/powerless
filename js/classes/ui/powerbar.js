class Powerbar extends Phaser.GameObjects.Container {
  constructor(frames = 20) {
    const FRAMEWIDTH = 32;
    super(scene, GAME_WIDTH / 2, 680); // Middle should be 640
    ...
    this.rectangle = scene.add.rectangle(-FRAMEWIDTH / 2 + 8, -FRAMEWIDTH / 2, frames * FRAMEWIDTH + FRAMEWIDTH * 2 - 16, FRAMEWIDTH, 0x45b9ea);
